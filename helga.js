...
╰────
`
sendButLocation(from, `${menu}`, `${uwu}H E L G A 右${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}menu`,buttonText:{displayText:'MENU'},type:1},{buttonId:`${prefix}info`,buttonText:{displayText:'INFO RULES'},type:1},{buttonId:`${prefix}store`,buttonText:{displayText:'SEWA BOT'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
        /*case 'help':
  case 'menu':
...
🕗 Wita : ${timeWita}
🕣 Wit : ${timeWit}`
sendButLocation(from, `${menu}`, `${uwu}H E L G A 右${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER👤'},type:1},{buttonId:`${prefix}store`,buttonText:{displayText:'SEWA BOT🌸'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
/*case 'sewa1':
               list = []
...
_◦➛${prefix}resepmasakan [ _judul_ ]_
_◦➛${prefix}artimimpi_
_◦➛${prefix}bilangangka [ _angka_ ]_
_◦➛${prefix}kalkulator [ _angka_ ]_
_◦➛${prefix}fancytext_
_◦➛${prefix}githubstalk [ _username_ ]_
...
buttons = [{buttonId: `menu`, buttonText: {displayText: 'MENU'}, type: 1},{buttonId: `store`, buttonText: {displayText: 'SEWA BOT'}, type: 1}]
const btnbc = {
